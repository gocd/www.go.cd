...
<div class="highlight" style="background:#FFF6E4">
	 To use the new features of 14.1, its necessary to upgrade your agent(s). See more details <a href="/2014/04/24/agent-bootstrapper-upgrade-for-plugins.html">here</a> about this.
</div>
