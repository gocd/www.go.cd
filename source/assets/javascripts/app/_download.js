    ...
    var showReleases = function (releaseData, cloudData) {
      var addInfo = function (latestRelease) {
        ...
        var notes = {
          ...
          generic: 'Note: Zip versions require a compatible LTS Java JRE/JDK.<br/><table><thead><tr><th style="width: 120px; vertical-align: top">GoCD version</th><th style="width: 120px; text-align: center">Java (Recommended)</th><th style="width: 120px; text-align: center">Java (Minimum)</th></tr></thead><tbody>' + javaCompat.map(function (row) { return ('<tr><td>' + row[0] + '</td><td style="text-align: center">' + row[1] + '</td><td style="text-align: center">' + row[2] + '</td></tr>'); }).join('') + '</tbody></table>'
        };
